...
python ./tls/static/client_tx.py --url wss://localhost:8080 --key ./tls/static/.crossbar/client.key --channel_binding="tls-unique"
wamp_tls_tx_cnlbind_unique_good=$?

python ./tls/static/client_tx.py --url wss://localhost:8080 --key ./tls/static/.crossbar/client03.key --channel_binding="tls-unique"
