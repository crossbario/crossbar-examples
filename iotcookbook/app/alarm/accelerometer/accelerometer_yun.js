...
// and sends accelerometer data from a Tinkerkit accelerometer module as part of the IoT Cookbook Alarm App 
//
...
console.log("Alarm App - Arduino Yun Accelerometer starting ...");
    ...
    connection.onopen = function (session) {
        ...
        *********************************/
        ...
        var get_accel_value = function() {
            ...
            session.publish("io.crossbar.examples.iotcookbook.alarmapp.on_accelerometer_data", ["yun", {x: x, y: y}]);
