...
;(function()
{
	...
	function Brush()
	{
		...
		var keywords =	'absolute action add after alter as asc at authorization begin bigint ' +
						...
						'int integer intersect into is isolation key last level load local loop max min ' +
						'minute modify move name national nchar next no numeric of off on only ' +
						'open option order out output package partial password precision prepare primary ' +
		...
		var webmq = 'webmq\.publish webmq\.export webmq\.REPOUSER';
